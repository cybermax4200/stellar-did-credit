...
/**
 * Governance proposal returned by the governance contract.
 *
 * The shape mirrors the Rust `GovernanceProposal` contract type. Soroban
 * `u64` and `i128` values are represented as `bigint` to avoid precision loss.
 */
